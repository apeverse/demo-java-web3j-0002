...
public class Main {
    public static void main(String[] args) {
        ...
        String node = "0x3d5d2e21162745e4df4f56471fd7f651f441adaaca25deb70e4738c6f63d1224";

        String address = "0xe26f015ba6b8c400cE327CeEBE34B717e6897e69";
        List<String> ret = getRecoverAddressFromSignature(signature, node, SIGN_NODE_PREFIX);
